...
const smsRestrict = () => { return `\`\`\`هذا الأمر مقيد من قِبل لايتو كن!!\`\`\`` }
...
//info-creadora.js
const smsCreA = () => { return 'ولكم'}
const smsCreB = () => { return 'معاك ℓɪɢнτ вστ'}
const smsCreC = () => { return 'موجود دايما عشان اساعدك'}

//info-cuentas-oficiales.js
const smsOfc1 = () => { return '🌸 *◜الحسابات الرسمية◞* 🌸'}
const smsOfc2 = () => { return `*❥ _تابعنا على الحسابات الرسمية لتبقى على اطلاع دائم مع_ ${flikelkobtan.1}*`}
