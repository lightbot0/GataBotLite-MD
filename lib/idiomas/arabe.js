...
//info-creadora.js
const smsCreA = () => { return 'يو برو'}
const smsCreB = () => { return 'انا ℓɪɢнτ вστ'}
const smsCreC = () => { return 'موجود دايما عشان اساعدك 🙂'}

//info-cuentas-oficiales.js
const smsOfc1 = () => { return '🌸 *◜الحسابات الرسمية◞* 🌸'}
const smsOfc2 = () => { return `*❥ _تابعني علي الانستغرام_ ${flikelkobtan.1}*`}

//info-donar.js
const smsMensajeDonar = () => { return `🌼  Instagram حتى يظل المستودع صالحًا ، شكرًا لك !!\n\n🌺 يمكنك دائمًا الدعم من خلال متابعة الحسابات الرسمية ومشاركة العمل المنجز فيها ${flikelkobtan.1}`}
...
//descargas.js
const smsYTA1 = () => { return 'جارٍ تنزيل الصوت ... اصبر ثانية يحبي'}

//descargas.js
const smsYTV1 = () => { return 'تحميل الفيديو ... اصبر ثانيه يقلبي'}

//descargas.js
const smsYTA2 = () => { return 'جارٍ تنزيل المستند الصوتي ... اصبر يعم'}

//descargas.js
const smsYTV2 = () => { return 'جارٍ تنزيل مستند الفيديو ... استني يحب'}
